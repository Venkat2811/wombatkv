...
//!
//! Stage 0: provide the BUGGIFY / AssertionLog / seeded RNG primitives
//! (BUGGIFY / Antithesis-style DST patterns). These are
//! domain-agnostic; the only thing per-project is which call sites
//! get the BUGGIFY macro and which invariants get asserted.
//!
